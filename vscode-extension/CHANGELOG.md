...
### Added
- **CI/CD Automation**: Finalized CI/CD automation.

### Fixed
- **Linting**: Resolved all ESLint errors in both extension and web-app (70+ fixes).

### Improved
- **Linting**: Isolated monorepo linting to avoid OOM errors.
